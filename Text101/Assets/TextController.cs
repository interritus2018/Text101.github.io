...
public class TextController : MonoBehaviour {
	...
	void cell () {
		text.text = "You are in a prison cell, and you want to escape. There are some " + 
				"dirty sheets on the bed, a mirror on the wall, and the door is locked " + 
				"from the outside.\n\n" + 
				"Press S to view Sheets, M to view Mirror, and L to view the Lcok";
	...
	void sheets_0 () {
		text.text = "You cannot believe you sleep in these things. Surely it is time somebody " + 
			"changed them. The pleasures of prison life " + 
			"I guess!\n\n" + 
	...
	void sheets_1 () {
		text.text = "holding a mirror in your hand does not make the sheets look " + 
			"any better.\n\n" + 
			"Press R to return to roaming your cell";
		if (Input.GetKeyDown (KeyCode.R)) {
	...
	void lock_0 () {
		text.text = "This is one of those button locks.. You have no idea what " + 
			"he combination is. You wish you could somehow see where the dirty " + 
	...
	void lock_1 () {
		text.text = "You carefully put hte mirror through the bars, and turn it round " + 
	...
	void cell_mirror () {
		text.text = "You are still in your cell, and you STILL want to escape! There are " +
			"some dirty sheets on the bes, a mark wher the mirror was, " +
	...
	void stairs_0 () {
		...
		"You realise it is not break time, and you will be caught immediately. " +
	...
	void stairs_1 () {
		text.text = "Unfortunately weilding a puny hairclip has not given you the " +
	...
	void stairs_2 () {
		text.text = "You feel smug for picking the closet door open, and are still armed with " +
			"a hairclip (now badly bent). Even these achievements together do not give "+
	...
	void corridor_1 () {
		text.text = "Still in the corridor. Floor still dirty. Hairclip in hand. " +
			"Now waht? You wonder if that lock on the closet would succumb to " +
	...
	void corridor_2 () {
		text.text = "Back in the corridor, having declined to dress-up as a cleaner.\n\n " +
			"Press C to revisite the Closet, and S to climb the stairs";
		if (Input.GetKeyDown (KeyCode.C)) {
			myState = States.in_closet;
		} else if (Input.GetKeyDown (KeyCode.S)){
	...
	void corridor_3 () {
		text.text = "You are standing back in the corridor, now convincingly dressed as a cleaner. " +
	...
	void closet_door () {
		text.text = "You are looking at a closet door, unfortunately it is locked. " +
